...
//Add!
          ...
          // Note: Needed for Polyfit Calc
          Eigen::VectorXd ptsx_car(ptsx.size());
          Eigen::VectorXd ptsy_car(ptsy.size());

          //Make Math simpler -- Transform global map coords to car coords
          ...
          */
          ...
          // Now fitting 3rd order polynomial --> 2nd order is convex curve
          ...
          // Assuming Latency for predicting time at actuation
          const double dt = 0.1;

          // Predict state after latency
          // The car is in origin in car coordinates (0,0) and orientation is parallel to x axis
          double pred_px = 0.0 + v * dt; // Note: cos(0) = 1
          const double pred_py = 0.0; // Note: sin(0) = 0
